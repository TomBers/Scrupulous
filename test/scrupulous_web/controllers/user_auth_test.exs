defmodule ScrupulousWeb.UserAuthTest do
  use ScrupulousWeb.ConnCase, async: true

  alias Scrupulous.Accounts
  alias ScrupulousWeb.UserAuth
  import Scrupulous.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ScrupulousWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ScrupulousWeb.Endpoint.subscribe(live_socket_id)
